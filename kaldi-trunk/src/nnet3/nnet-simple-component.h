...
/** GradientReversalComponent (GRL) related to adversarial learning. Transparent when feeding foward
	multiplies with positive factor (gr_weight) * back_propagation
   Accepted configuration values:
           gr-weight          gradient reversal task weight (normally >0)
...
class GradientReversalComponent: public NonlinearComponent {
 public:
  ...
  // void Init(int32 dim, BaseFloat gr_weight);
