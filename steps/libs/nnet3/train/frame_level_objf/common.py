...
def train_one_iteration(dir, iter, srand, egs_dir,
    ...
    if os.path.isfile("{dir}/configs/grlweight/grlweight.{iter}.config".format(dir=dir, iter=iter)):
        raw_model_string = ("nnet3-copy --learning-rate={lr} --scale={s} --nnet-config={dir}/configs/grlweight/grlweight.{iter}.config "
                        "{dir}/{iter}.{suf} - |".format(
